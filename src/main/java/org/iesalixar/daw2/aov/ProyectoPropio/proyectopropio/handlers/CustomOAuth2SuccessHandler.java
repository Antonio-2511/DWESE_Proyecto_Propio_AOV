package org.iesalixar.daw2.aov.ProyectoPropio.proyectopropio.handlers;

import jakarta.servlet.ServletException;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import org.iesalixar.daw2.aov.ProyectoPropio.proyectopropio.repositories.UserRepository;
import org.iesalixar.daw2.aov.ProyectoPropio.proyectopropio.services.CustomUserDetailsService;
...
public class CustomOAuth2SuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        if (userRepository.findByEmail(username).isEmpty()) {
            throw new OAuth2AuthenticationException("Usuario no registrado");
        }
